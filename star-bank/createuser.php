...
<head>
    ...
    <title>STAR Bank- Create User</title>
...
?>
    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-warning py-3 navigation ">
            <a class="navbar-brand" href="#">STAR  Bank</a>
    ...
    <br><br><br><br><br>
     ...
     <section class="usercard">
      ...
      padding-top: 35px;
      ">
       <p style="font-size: 20px;">Copyright 2021. All rights reserved. Made by - HEMANGINI PATIL</p>
      </footer>
